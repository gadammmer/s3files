...
create or replace task PROCESS.LOAD_AX_INE_OFERTA_ALOJAMIENTOS
	USER_TASK_MANAGED_INITIAL_WAREHOUSE_SIZE=''XLARGE''
	after PROCESS.LOAD_AX_INE_VIAJEROS_Y_PERNOCTACIONES
	as BEGIN

          create or replace TABLE PROCESS.AX_INE_OFERTA_ALOJAMIENTOS (
              FECHA DATE,
              VALOR FLOAT,
              FAMILIA VARCHAR(50),
              TABLA VARCHAR(10),
              ...
              INSERT INTO PROCESS.AX_INE_OFERTA_ALOJAMIENTOS (
              SELECT 
                S.FECHA,
                S.VALOR,
                S.FAMILIA,
              ...
              INNER JOIN PROCESS.RL_INE_OFERTA_ALOJAMIENTOS D
