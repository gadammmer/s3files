CREATE or REPLACE TABLE PROCESS.AX_FLX_NOS_BY_CITY_PRE_ALL_TODAY
(
...
(select DISTINCT LOAD_DATE from STAGING.ST_FLX_NOCHEESTANCIA_MUNICIPIO) M	
...
ELSE
*/
            CREATE or REPLACE TABLE PROCESS.AX_FLX_NOS_BY_CITY_ALL_TODAY
        (
          PERIOD_KEY       NUMBER (16,0) ,
          ZONE_ID  VARCHAR(100) ,
          VISITOR_ORIGIN_ID  VARCHAR(20) ,
        ...
        CREATE or REPLACE TABLE PROCESS.AX_FLX_NOS_BY_CITY
        (
          PERIOD_KEY       NUMBER (16,0) ,
        ...
        (select distinct PERIOD_KEY,zone_ID from  PROCESS.AX_FLX_NOS_BY_CITY_ALL_TODAY) b
...
/*
    ...
    ELSE
      */   
        CREATE or REPLACE TABLE SIT.FC_FLX_NOS_BY_CITY
        (
          PERIOD_KEY       NUMBER (16,0) ,
          ZONE_KEY  NUMBER (16,0) ,
          VISITOR_ORIGIN_KEY  NUMBER (16,0) ,
...
*/
    ...
    END;
*/
CREATE or REPLACE TABLE PROCESS.AX_FLX_NOS_PRE_ALL_TODAY
(
  PERIOD_KEY NUMBER (16,0) ,
  ZONE_ID  VARCHAR(100) ,
  VISITOR_ORIGIN_ID  VARCHAR(20) ,
...
(select DISTINCT LOAD_DATE from STAGING.ST_FLX_NOCHEESTANCIA) M	
	where a.load_date=m.load_date  
    AND (trim(CONTINUO) = 'nc' AND FILE_NAME NOT LIKE '%INVA-1080-6642%')
    AND FILE_NAME NOT LIKE '%INVA-1080-9999%'   
),
...
ELSE
*/
            CREATE or REPLACE TABLE PROCESS.AX_FLX_NOS_ALL_TODAY
        (
          PERIOD_KEY       NUMBER (16,0) ,
          ZONE_ID  VARCHAR(100) ,
          VISITOR_ORIGIN_ID  VARCHAR(20) ,
...
/*
    ...
    ELSE
    */
                CREATE or REPLACE TABLE SIT.FC_FLX_NOS
        (
          PERIOD_KEY       NUMBER (16,0) ,
          ZONE_KEY  NUMBER (16,0) ,
          VISITOR_ORIGIN_KEY  NUMBER (16,0) ,
