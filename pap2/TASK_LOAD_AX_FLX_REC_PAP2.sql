EXECUTE IMMEDIATE '
    BEGIN
        create or replace task PROCESS.LOAD_AX_FLX_REC
...
/*
        ...
        END;
         RETURN ''Task LOAD_AX_FLX_REC creada correctamente'';
    END;
';


ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_REC RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_PLACE_V2 RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_PLACE_V1 RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_NOS RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_LOS RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_BY_GENDER RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_BY_CITY RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_AGE RESUME;
ALTER TASK IF EXISTS PROCESS.LOAD_AX_FLX_2H RESUME;
